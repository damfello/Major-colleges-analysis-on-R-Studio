...
```{r Update the ClickHouse Package}
...
conCH <- DBI::dbConnect(RClickhouse::clickhouse(),
                            host="s10.techadsmedia.com",
                            port=9000,
                            user="marketing",
                            password="ONkxMmsNDKFCqxidyICmlvyczE3")


DBI::dbGetQuery(conCH, "SHOW DATABASES")

ConMy <- odbcConnect("mysql_techads",
                     uid= "readOnly4all",
                     pwd= "7CHdeUf07hXK4xqxgKWRGkLtGN4ErucIZ0k0YhOVfubYN2q")
